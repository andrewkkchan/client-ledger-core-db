...
public class ConsumerImplTest {
    ...
    public void before() {
        ...
        consumer = new ConsumerImpl(Collections.singletonList(processor), objectMapper, transactionEventRepository, transactionResultRepository, kafkaConsumer, executorService, logger);
